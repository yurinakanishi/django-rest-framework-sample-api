...
#     with open("a.json") as ff:
#         arts_each_data = json.load(ff)
...
#     genre_for_url_for_arts_each = GenreForUrl.objects.get(name="arts/each")
...
#     for a in reversed(arts_each_data):
#         if a.get("language") == "en":
#             language = language_en
#         else:
#             language = language_jp
...
#                 name=a.get("name"),
#                 slug=a.get("slug"),
#                 genre_for_url=genre_for_url_for_arts_each,
#                 language=language,
#             )
#         )
...
#     for article, art_each in zip(articles_for_arts_each_list, arts_each_list):
#         art_each.article = article
